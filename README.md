...
graph TD
    A[Benchmark<br/>11,726 samples] --> B[Theory<br/>436]
    A --> C[Normal Calculation<br/>4,090]
    A --> D[Function Simplify<br/>7,200]
    
    C --> E[Binary Calculator<br/>100]
    C --> F[Number System Conversions<br/>3,072]
    C --> G[Sign/Magnitude Number<br/>312]
    C --> H[One's-complement<br/>297]
    C --> I[Two's-complement<br/>309]
    
    D --> J[3-variable kmap<br/>3,500]
    D --> K[4-variable kmap<br/>3,500]
    D --> L[5-variable kmap<br/>100]
    D --> M[6-variable kmap<br/>100]
    
    style A fill:#4682B4,stroke:#2F4F4F,stroke-width:3px,color:#fff
    ...
    style E fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style F fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style G fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style H fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style I fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style J fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style K fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style L fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
    style M fill:#B0E0E6,stroke:#87CEEB,stroke-width:1px
```

**Dataset Hierarchy:**
- **🎯 Center**: Benchmark (Total dataset)
- **🔵 Inner Ring**: 3 main categories (Theory, Normal Calculation, Function Simplify)
- **🔷 Outer Ring**: 10 specific problem types with sample counts
